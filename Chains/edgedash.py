...
class Edgedash(Chain):
    ...
    def step(self, gamestate, smashbot_state, opponent_state):
        ...
        if smashbot_state.action == Action.JUMPING_ARIAL_FORWARD:
            #TODO FIX THIS JUST CHANGED EVERYTHING TO 0.5
            # Wait until we're at least 0.5 above stage, or else we'll miss
            if smashbot_state.position.y + smashbot_state.ecb.bottom.y > 0.5:
                airdodge_angle = 0.5
